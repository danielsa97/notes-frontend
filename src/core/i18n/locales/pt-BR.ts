export default {
  ...
  dashboard: {
    ...
    dailyExecutionOverview: "Execução de Hoje",
    pendingItems: "Itens pendentes",
    completedToday: "Concluídas hoje",
    inProgressToday: "Em andamento",
    roomsWithProblems: "Quartos com pendências",
    recurringIssuesTitle: "Alertas recorrentes por quarto",
    noRoomsWithProblems: "Nenhum quarto com pendências hoje",
    chartTitle: "Distribuição das Atividades do Dia",
  ...
  tasks: {
    title: "Tarefas",
    subtitle: "Gestão de tarefas do workspace {workspace}",
    add: "+ Nova Tarefa",
    errorTitle: "Erro",
    empty: "Nenhuma tarefa encontrada.",
    selectedDate: "Data de referência",
    runDate: "Data da execução",
    pendingItems: "Itens pendentes",
    exportDailyCsv: "Exportar fechamento (CSV)",
    historyFrom: "Histórico de",
    historyTo: "até",
    loadHistory: "Carregar histórico",
    historyRuns: "execuções",
    noHistory: "Sem dados no período selecionado.",
    recurringAlertTitle: "Alerta de recorrência",
    recurringAlertDescription:
      "Quartos abaixo aparecem com pendências recorrentes na última semana.",
    modalExecutionTitle: "Execução da atividade",
    executionNotePlaceholder:
      "Observações da execução para este quarto/local...",
    itemsSummary: "{done}/{total} itens concluídos",
    noDescription: "Sem descrição",
    imageUploadLabel: "Imagens (até 5)",
    imageUploadHint: "Formatos de imagem suportados. Máximo de 5 arquivos.",
    evidenceUploadLabel: "Imagens de evidência (até 5)",
    maxImagesError: "Você pode selecionar no máximo 5 imagens.",
    commonAreaLabel: "Área Comum",
    commonAreaHint:
      "Atividade em área genérica do hotel (ex: jardim, recepção). Registre o local nos comentários.",
    dueDate: "Vencimento",
    ...
    sortByDueDate: "Ordenar por vencimento",
    sortAsc: "Mais próximas",
    sortDesc: "Mais distantes",
    sortDefault: "Padrão (criação)",
    rooms: "Quarto(s)",
    noRooms: "Nenhum quarto atribuído",
    typeValues: {
      ROTINEIRA: "Rotineira",
    ...
    form: {
      title: "Título",
      titlePlaceholder: "Ex: Trocar lençóis",
      description: "Descrição (opcional)",
      descriptionPlaceholder: "Descreva a tarefa...",
      type: "Tipo da atividade",
      dueDate: "Data de vencimento (opcional)",
      startsOn: "Início da rotina (opcional)",
      endsOn: "Fim da rotina (opcional)",
      rooms: "Quartos associados",
      roomsHint: "Selecione os quartos relacionados ou marque Área Comum.",
      isCommonArea: "Área Comum (jardim, recepção, etc.)",
    },
    modalAddTitle: "Nova Tarefa",
    modalDetailTitle: "Detalhes da Tarefa",
    actions: {
      markInProgress: "Marcar como Em Andamento",
      markDone: "Marcar como Concluída",
      markCancelled: "Cancelar Tarefa",
    },
    comments: {
      title: "Comentários",
      addPlaceholder: "Adicione um comentário ou observação...",
      addButton: "Comentar",
      empty: "Nenhum comentário ainda.",
      addEvidence: "Adicionar imagens de evidência",
    },
    statusValues: {
      PENDENTE: "Pendente",
    ...
    errors: {
      fetchTasks: "Falha ao carregar tarefas.",
      fetchTask: "Falha ao carregar tarefa.",
      createTask: "Falha ao criar tarefa.",
      updateStatus: "Falha ao atualizar status.",
      addComment: "Falha ao adicionar comentário.",
    },
  },
  workspace: {
